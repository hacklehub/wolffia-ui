...
1. To toggle dark mode for tailwind, click the crescent moon icon at the tool. (Note: The icon next to it will not work, because we have to set a tailwind class "dark" at the highest level )
